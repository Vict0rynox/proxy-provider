...
import org.vicotynox.proxy.provider.repository.DoobieTodoRepository.SQL
import org.vicotynox.proxy.provider.{TodoId, TodoItem, TodoItemPatchForm, TodoItemPostForm, TodoPayload}
import zio.{Task, ZIO}
...
trait DoobieTodoRepository extends TodoRepository {
  ...
  val todoRepository: TodoRepository.Service[Any] = new TodoRepository.Service[Any] {
...
object DoobieTodoRepository {
  ...
  object SQL {
    def create(todo: TodoPayload): Update0 =
      sql"""
